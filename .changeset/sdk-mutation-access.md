---
"@totoday/quinn-sdk": patch
---

Add `mutationAccess` to the Quinn SDK runtime config so agent runtimes can gate Quinn business mutations without changing the default SDK behavior.
